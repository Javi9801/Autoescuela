...
<body>
    ...
    <section class="contenido">
        ...
        <h1>Alta Usuario</h1>
            ...
            <p><input type="email" class="campos" id="usuario_email" name="usuario_email" value=""></p>

            <label for="usuario_nombre">Nombre</label>
            <p><input type="text" class="campos letras" id="usuario_nombre" name="usuario_nombre" value=""></p>

            <label for="usuario_apellidos">Apellidos</label>
            <p><input type="text" class="campos letras" id="usuario_apellidos" name="usuario_apellidos" value=""></p>

            <label for="usuario_fecha">Fecha Nacimiento</label>
            <p><input type="date" class="campos" id="usuario_fecha" name="usuario_fecha" value=""></p>

            <label for="usuario_imagen">Foto Usuario</label>
            <p><input type="file" 1ºid="usuario_imagen" name="usuario_imagen" value=""></p>
